export const poseInstructions = {
    Tree: [
        'Állj pozícióba. A fa póz gyakran a hegyi pózból (vagy Tadasana) indul, mindkét lábával szilárdan a talajon, és a testsúly megfelelően eloszlik, hogy egyensúlyban legyen.',
